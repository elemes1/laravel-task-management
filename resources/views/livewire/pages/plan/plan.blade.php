                                        ...
                                        <div class="bg-gray-100 pb-4 rounded-lg shadow overflow-y-auto overflow-x-hidden border-t-8"
                                            ...
                                            <div class="px-4">
                                                <div @dragover="onDragOver(event)" @drop="onDrop(event, board)"
                                                    ...
                                                    <template x-for="(t, t.id) in tasks.filter(t => t.status === board)" :key="t.id">
                                                        ...
                                                        <div :id="t.id">
                                                            <div x-show="t.edit == false">
                                                                <div x-show="t.edit == false"
                                                                    ...
                                                                    <div x-text="formatDateDisplay(t.created_at)"
                                                                    ...
                                                                    <div class="flex items-center w-full mt-3 text-xs font-medium text-gray-400">
                                                                        <div class="flex items-center">
                                                                            ...
                                                                            <span class="ml-1 leading-none"  x-text="formatDateDisplay(t.due_date)"></span>
                                                                        </div>
                                                            ...
                                                            <div x-show="t.edit == true"
                                                                    class="bg-white rounded-lg p-4 shadow mb-4">
                                                                <div class="mb-4">
                                                                    <label class="text-gray-800 block mb-1 font-bold text-sm">Task
                                                                        Name</label>
                                                                    <input :x-ref="t.id" class="bg-gray-200 appearance-none border-2 border-gray-200 rounded-lg w-full py-2 px-2 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-blue-500"
                                                               ...
                                                               <div class="flex flex-row">
                                                                   <div class="text-left">
                                                                       <button type="button"
                                                                           ...
                                                                           <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4 stroke-cyan-500">
